...
import com.savingsbank.homebanking.dtos.LoanApplicationDTO;
import com.savingsbank.homebanking.dtos.LoanDTO;
import com.savingsbank.homebanking.models.*;
import com.savingsbank.homebanking.services.*;
...
public class LoanController {
    ...
    public ResponseEntity<Object> applyForLoan (Authentication authentication, @RequestBody LoanApplicationDTO loanApplicationDTO) {
        ...
        if (loanApplicationDTO.destinationAccount().isBlank()) {
        ...
        double amount = loanApplicationDTO.amount() + (loanApplicationDTO.amount() * loan.getInterestPercentage());
        Double currentAmount = amount;
        ClientLoan clientLoan = new ClientLoan(amount,loanApplicationDTO.payments(),currentAmount,
                loanApplicationDTO.payments());

        client.addClientLoan(clientLoan);
        loan.addClientLoan(clientLoan);
        clientLoanService.saveClientLoan(clientLoan);

        double currentBalanceAccountCredit = account.getBalance() + loanApplicationDTO.amount();

        Transaction transactionCredit = new Transaction(TransactionType.CREDIT,
                loanApplicationDTO.amount(), loan.getName() + " Loan approved",
